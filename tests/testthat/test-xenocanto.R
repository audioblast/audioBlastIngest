...
test_that("ingestR empties what a streamed source gave before, once for each table", {
  ...
  #Images, details and links replace what the source gave; the rest are updated
  #by id. Each is emptied once, before its first chunk, however many chunks it
  #takes: emptying it per chunk would keep only the last one.
