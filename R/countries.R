...
#United Republic of") and the names in common use that neither covers (United
#States, Laos, Ivory Coast). A shortening that two countries share (Congo,
#Korea, Virgin Islands) is left out, as it names neither of them.
#
...
countryNames <- c(
  ...
  "bhutan"="BT", "bolivia"="BO", "bolivia, plurinational state of"="BO", "bonaire"="BQ",
  ...
  "heard island and mcdonald islands"="HM", "holy see"="VA", "honduras"="HN", "hong kong"="HK",
  "hong kong sar china"="HK", "hungary"="HU", "iceland"="IS", "india"="IN", "indonesia"="ID",
  "iran"="IR", "iran, islamic republic of"="IR", "iraq"="IQ", "ireland"="IE",
  "isle of man"="IM", "israel"="IL", "italy"="IT", "ivory coast"="CI", "jamaica"="JM",
  ...
  "tanzania, united republic of"="TZ", "thailand"="TH", "the bahamas"="BS", "the gambia"="GM",
  "timor-leste"="TL", "togo"="TG", "tokelau"="TK", "tonga"="TO", "trinidad and tobago"="TT",
  "tunisia"="TN", "turkey"="TR", "turkiye"="TR", "turkmenistan"="TM",
  "turks and caicos islands"="TC", "tuvalu"="TV", "uganda"="UG", "uk"="GB", "ukraine"="UA",
  "united arab emirates"="AE", "united kingdom"="GB",
  "united kingdom of great britain and northern ireland"="GB", "united states"="US",
  ...
  "wallis and futuna"="WF", "wallis and futuna islands"="WF", "western sahara"="EH",
  "yemen"="YE", "zaire"="CD", "zambia"="ZM", "zimbabwe"="ZW"
)
