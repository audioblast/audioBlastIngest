...
countryOtherNames <- c(
  ...
  #xeno-canto drops the and, and tells the two Congos apart in brackets. Its
  #133 country names were all read with these on 2026-09-20.
  BA="Bosnia Herzegovina", AG="Antigua Barbuda", TT="Trinidad Tobago",
  KN="Saint Kitts Nevis", ST="Sao Tome Principe", TC="Turks Caicos Islands",
  CG="Congo (Brazzaville)", CD="Congo (Democratic Republic)")
